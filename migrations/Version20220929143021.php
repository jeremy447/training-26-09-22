 ...
 */
final class Version20220929143021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, birthday DATE DEFAULT NULL --(DC2Type:date_immutable), last_connected_at DATETIME NOT NULL
        )');
    }
